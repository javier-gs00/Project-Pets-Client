...
function apiFindProductById(id) {
    // console.log("search query sent...")
...
function findProductsByCategory(category, cb) {
    // console.log('search query sent')
...
function apiGetStoreByName(name) {
    // console.log("Search query sent...")
    let promise = Promise.resolve()
...
function apiProductsSearch(query = "royal canin maxi") {
...
function apiGetProductsByCategory(category) {
    return new Promise (function(resolve, reject) {
